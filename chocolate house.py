...
def add_flavor():
    ...
    name = input("Enter the name of the flavor: ")
...
def manage_ingredient_inventory():
    ...
    if choice == '1':
        ...
        ingredient_name = input("Enter the name of ingredient desired to update: ")
        new_quantity = int(input("Enter the fresh quantity: "))
...
def add_customer_feedback():
    ...
    suggestion = input("can you please suggest your flavor: ")
